...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] = //òàáëèöà îøèáîê
	{
		...
		ERROR_ENTRY(704, "[SemA]: Òèï äàííûõ ğåçóëüòàòà âûğàæåíèÿ íå ñîîòâåòñòâóåò ïğèñâàèâàåìîìó èäåíòèôèêàòîğó"),//+
		ERROR_ENTRY(705, "[SemA]: LIB Function length:íåïğàâèëüíî ïåğåäàíû ïàğàìåòğû "),
